...
namespace Badoucai.Library
{
    public class ImageFactory
    {
        ...
        /// </summary>
        private static readonly PixelFormat[] indexedPixelFormats = { PixelFormat.Undefined, PixelFormat.DontCare, PixelFormat.Format16bppArgb1555, PixelFormat.Format1bppIndexed, PixelFormat.Format4bppIndexed, PixelFormat.Format8bppIndexed };
        ...
        private static void PixelFormatIndexedFormat(string imgPath)
        {
        ...
        public static string LetterWatermark(string path, int size, string letter, Color color, string location)
        {
            ...
            if (kz_name == ".jpg" || kz_name == ".bmp" || kz_name == ".jpeg")
            {
                ...
                if (IsPixelFormatIndexed(img.PixelFormat))
                {
                    ...
                    var loca = GetLocation(location, bmp, size, letter.Length);
