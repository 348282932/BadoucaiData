...
namespace Badoucai.Library
{
    ...
    {
        private readonly string path = AppDomain.CurrentDomain.BaseDirectory.Remove(AppDomain.CurrentDomain.BaseDirectory.IndexOf("bin", StringComparison.Ordinal) - 1) + "\\Cache\\";
